...
* [Getting Started](get-started/tada-component.md)
    * [Frontend](get-started/tada-front-end.md)
    * [Creating the Database Table](get-started/creating-the-database.md)
    * [Views](get-started/tada-views.md)
    * [Backend](get-started/tada-backend.md)
    * [Editing Data](get-started/editing-data.md)
